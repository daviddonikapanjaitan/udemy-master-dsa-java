package C9CircularDoublyLinkedList;

import C9CircularDoublyLinkedList.DoublyNode;

public class P1CircularDoublyLinkedList {
    ...
    public static void main(String[] args) {
        P1CircularDoublyLinkedList cdll = new P1CircularDoublyLinkedList();
        cdll.createCDLL(1);
        cdll.insertNode(2, 0);
        cdll.insertNode(3, 2);
        cdll.insertNode(4, 5);
